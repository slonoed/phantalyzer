(function (realConsole) {
    ...
    var console = {
        log: function () {
            debug && realConsole.log.apply(realConsole, arguments);
            programOut += Array.prototype.join.call(arguments, ' ') + '\n';
        }
    };
    ...
    function sendExitData(stdout) {
        ...
        var jsonOut = JSON.stringify(outputObj, null, 4);

        realConsole.log(jsonOut);
    }
            ...
            if (!isRedirect) {
                ...
                if (resource.status < 200 || resource.status > 226) {
                    ...
                    try {
                        ...
                        var toLowerCase = function (item, index) {
